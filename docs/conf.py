...
context = {
    ...
    'downloads': [ 
    ("html", "//readthecheatsheets.readthedocs.io/_/downloads/en/latest/htmlzip/"),
    ],
    'subprojects': [ 
    ],
    'slug': 'readthecheatsheets',
    'name': u'readthecheatsheets',
    'rtd_language': u'en',
    'programming_language': u'words',
    'canonical_url': 'https://readthecheatsheets.readthedocs.io/en/latest/',
    'analytics_code': 'None',
    'single_version': False,
    'conf_py_path': '/docs/',
    'api_host': 'https://readthedocs.org',
    'github_user': 'tabrizu891',
    'proxied_api_host': '/_',
...
if 'branch' == 'external':
    ...
    readthedocs_build_url = 'https://readthedocs.org/projects/readthecheatsheets/builds/19903559/'
